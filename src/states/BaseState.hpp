...
public:
    ...
    virtual void enter(std::shared_ptr<World> world, std::shared_ptr<Bird> bird) noexcept {}  /*mi manejo de world y bird en otros estados*/ 

    virtual void exit() noexcept {}

    virtual void handle_inputs(const sf::Event& event) noexcept {}

    /*virtual void handle_inputs1(const sf::Event& event) noexcept {}*/
