...
OBJ_RULES = text_utilities.o Settings.o Game.o Bird.o Log.o LogPair.o World.o StateMachine.o TitleScreenState.o CountDownState.o PlayingState.o PauseState.o MenuState.o 
...
MenuState.o: $(BUILD_DIR) src/states/MenuState.hpp src/states/MenuState.cpp
	$(CXX) -c $(INCLUDE) src/states/MenuState.cpp -o $(BUILD_DIR)/$@	
